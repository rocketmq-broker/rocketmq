...
/**
 * Service class managing live alert module operations.
 *
 * Defines schemas, types, or services for live alert module inside the NestJS client.
 */
